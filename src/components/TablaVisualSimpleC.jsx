// src/components/TablaVisualSimpleC.jsx
import styles from '../styles/TablaVisualSimpleC.module.css';
...
export default function TablaVisualSimpleC() {
  ...
  const maxPrice = getMaxPriceHour(data)?.price ?? 0;
